...
public class SubdividePlugin : IMajPlugin
{
    ...
    public IEnumerable<PluginAction> GetActions()
    {
        ...
        {
            Name = Assets.Langs.Langs.Gui_Subdivide1p5x,
            IconKey = null,
            Transform = text => SimaiSubdivide.Subdivide(text, 1.5f)
        };
        yield return new PluginAction
        {
            Name = Assets.Langs.Langs.Gui_Subdivide2x,
            IconKey = null,
            Transform = text => SimaiSubdivide.Subdivide(text, 2.0f)
        };
    }
